        ...
        <center>
          <table cellspacing="0" cellpadding="0" width="600" class="w320">
            ...
            <tr>
              <td class="button">
                <div><!--[if mso]>
                  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ URL::to('/#/newpassword/'. $email . '/' . $token) }}" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                    <w:anchorlock/>
                ...
                <![endif]--><a class="button-mobile" href="{{'https://digitransfer.digipay-services.com/newpassword/'. $email . '/' . $token }}"
            ...
            <tr>
              <td class="free-text">
                {{'https://digitransfer.digipay-services.com/newpassword/'. $email . '/' . $token }}
              </td>
            </tr>
          </table>
        </center>
          ...
          <table cellspacing="0" cellpadding="0" width="600" class="w320">
            <tr>
              <td style="padding: 25px 0 25px">
                <strong>tholadpay.com</strong><br />
              </td>
            </tr>
          </table>
        </center>
